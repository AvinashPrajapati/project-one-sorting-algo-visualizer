...
UI_frame.grid(row=0, column=0, padx=10, pady=5, sticky=NE)

UI_frame1 = Frame(window, bg=WHITE)
UI_frame1.grid(row=0, column=0, padx=10, pady=30, sticky=NW)

Label(UI_frame1, bg=WHITE, text='Sorting Algorithm visualiser :', font=("Verdana", 25), justify=CENTER).grid(column=0, row=0, sticky=W)
...
b1 = Button(UI_frame, text="Sort Array", command=sort, bg=LIGHT_GRAY)
b1.grid(row=2, column=1, padx=5, pady=5, sticky=W)

b3 = Button(UI_frame, text="Randomise Array", command=generate, bg=LIGHT_GRAY)
